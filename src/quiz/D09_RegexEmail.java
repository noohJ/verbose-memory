...
public class D09_RegexEmail {
	/*
	   	1. emails 문자열에에 있는 올ㅇ바른 이메일만 모두 ArrayList에 저장하세요.
	  		(1번에서 생성한 리스트의 크기도)
	  	2. 어떤 도메인이 몇개나 있는지 세어서 출력해보세요.	  	
	  
	*/
	final static String emails= "선일보	가정/육아	박은주	zeeny@chosun.com\r\n"
			...
			+ "매일경제	　	황시영	@shinyandloo";
//	public static void main(String[] args) {
//		Pattern pattern = Pattern.compile("\\w+@\\w+.\\w+(.\\w+)*");
//		Matcher matcher = pattern.matcher(emails);
//		ArrayList<String> email = new ArrayList<>();
//		ArrayList<String> domaincount = new ArrayList<>();
//		ArrayList<String> domain =new ArrayList<>();		
//		ArrayList<Domain> domainfinal = new ArrayList<>();
//		while (matcher.find()) {
...
////		System.out.println(email.size());
//		for (int i = 0;i < email.size(); ++i ) {
//			int dom = email.get(i).indexOf("@");
//			domaincount.add(email.get(i).substring(dom+1));
//			domain.remove(email.get(i).substring(dom+1));
//			domain.add(email.get(i).substring(dom+1));
//		}
//		
//		for(int i = 0; i <domain.size(); ++i){
//			int numdomain = Collections.frequency(domaincount,(domain.get(i)));
//			
//			domainfinal.add(new Domain((domain.get(i)),numdomain));
//		}	
//		Collections.sort(domainfinal);
//		Collections.reverse(domainfinal);
//		for (int i = 0; i < domainfinal.size();++i) {
//			System.out.println(domainfinal.get(i));
//		}
//		
//	}
//}
...
//	String domain;
//	int count;
//	public Domain(String domain, int count) {
//		ArrayList<String>domainsub = new ArrayList<>();
//		this.domain = domain;
//		this.count = count;
//		domainsub.add(domain);
//		domainsub.add(Integer.toString(count));
//	}
//	public String toString() {
//		return String.format("도메인 : %s \n사용자수 : %d명", domain,count);
//	}
//	@Override
//	public int compareTo(Object o) {
//		// TODO Auto-generated method stub
//		return Integer.compare(this.count,((Domain)o).count);
//	}
//}
//
